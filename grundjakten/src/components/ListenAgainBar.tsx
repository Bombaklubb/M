...
/**
 * Den fasta listen längst ned: stort öra och hem.
 *
 ...
 */
export function ListenAgainBar({ replay, onHome }: Props) {
  const { speaking, speak } = useSpeak();

  return (
    <div className="sticky bottom-0 z-30 flex items-center justify-center gap-5
