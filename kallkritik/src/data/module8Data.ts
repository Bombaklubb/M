...
export const MODULE8_QUESTIONS: Module8Question[] = [
  {
    ...
    platform: 'Instagram',
    platformIcon: '📸',
    postContent: '✨ Äntligen hittat något som faktiskt funkar för min hud!! Den här krämen från @GlowSkin_SE har förändrat allt. Huden känns mjuk, jämn och strålande – efter bara två veckor! Länk i bio 🔗 #glowup #hudvård #naturligt',
  ...
  },
  {
    ...
    platform: 'YouTube',
    platformIcon: '▶️',
    postContent: 'VIDEO: "Jag testade 5 gaming-headsets under 500 kr – ÄRLIG recension!"\n\nI videobeskrivningen (expanderas manuellt): "Alla produkter i den här videon är köpta med egna pengar och representerar mina egna åsikter. *Vissa länkar är affiliatelänkar – jag får en liten provision om du köper via dem, utan extra kostnad för dig."',
