...
export const MODULE2_TEXTS: FindErrorText[] = [
  {
    ...
    segments: [
      ...
      { text: 'Göteborg', isError: true, errorExplanation: 'Stockholms är Sveriges huvudstad. Göteborg är landets näst folkrikaste stad.' },
  ...
  },
  {
    ...
    segments: [
      ...
      { text: 'Steve Jobs', isError: true, errorExplanation: 'Internet skapades inte av Steve Jobs. Det växte fram ur det militära nätverket ARPANET på 1960–70-talet, utvecklat av amerikanska forskare och ingenjörer som Vint Cerf och Bob Kahn.' },
