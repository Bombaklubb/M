...
export const JaktLinks: React.FC = () => {
  ...
  return (
    <div className="relative inline-block" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute bottom-full right-0 mb-2 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700 py-2 min-w-[180px] z-50">
          {JAKT_APPS.map((app) => (
            <a
              key={app.name}
              href={app.url}
