...
const NYA_DISTRAKTORER = {
  ...
  // ── Sats 11 (sista) ──
  // Här är facit i flera fall det KORTASTE alternativet, så distraktorerna
  // kortas ned i stället för att förlängas.
  'ak3-tema-014|2': ['Museet', 'Badet', 'Gården'],
  'ak4-halsa-cykel-001|3': ['Cykla på', 'Öka fart', 'Svänga'],
  'ak1-miljo-04|1': ['Ris', 'Ull', 'Lim'],
  'ak1-tema-009|3': ['Sten', 'Bär', 'Bark'],
  'ak4-tema-005|1': ['Bari', 'Pisa', 'Como'],
  'ak7-vanskap-01|3': ['NO', 'Sfi', 'Hkk'],
  'ak7-tema-035|5': ['Tristess', 'Regn', 'Kyla'],
  'ak6-tema-026|1': ['Ost', 'Ris', 'Bär'],
  'ak8-samhalle-02|1': ['Rätt över andras kropp', 'Rätt att slippa regler', 'Rätt att alltid vinna'],
  'ak4-bamse-001|5': ['Låna och lämna åter', 'Byta mot annat', 'Skriva en lapp'],
  'ak1-tema-018|4': ['Mamma', 'Pappa', 'Elsa'],
  'ak7-tema-037|5': ['Genom att skriva lagar', 'Genom att strunta i det', 'Genom att stoppa allt'],
  'ak10-tema-005|1': ['Hur ekonomiska investeringar styr all magi', 'Hur man bygger maskiner utan besvärjelser', 'Hur man tränar styrka för att vinna tävlingar'],
  'ak1-miljo-04|5': ['För att lampan blir grön', 'För att den ska sjunga', 'För att skärmen växer'],
  'ak1-samhalle-skola-001|5': ['Ida', 'Otto', 'Nils'],
  'ak1-tema-026|5': ['Går', 'Ser', 'Står'],
  'ak1-tema-036|5': ['Går', 'Ser', 'Står'],
  'ak3-sport-004|2': ['Hon vill spela', 'Hon tappat skon', 'Hon är hungrig'],
  'ak3-tema-007|3': ['En fågel i trädet', 'En snögubbe på gården', 'Ett par tappade vantar'],
  'ak1-tema-046|5': ['Går', 'Ser', 'Står'],
  'ak5-samhalle-04|2': ['Vädret', 'Havet', 'Rymden'],
  'ak8-tema-028|1': ['I en skolsal', 'I ett hem på landet', 'I en stor park'],

  'ak10-arsenal-004|5': ['Träningstidernas längd', 'Längden på matcherna', 'Publikens klädsel'],
  'akgy-tema-011|3': ['Den är störst av alla planeter', 'Den har tydliga ringar runt sig', 'Den ligger närmast solen'],
  'ak9-tema-017|6': ['Att ull har slutat produceras helt i världen', 'Att reklam för kläder blivit olaglig', 'Att alla arbetsplatser kräver uniform'],
  'ak4-miljo-04|4': ['För att man bygger fler nya vägar', 'För att man får ännu fler sopor', 'För att man gör allting tyngre'],
  'ak6-tema-025|3': ['Det lät precis exakt likadant som på Sun Records', 'Ljudet blev sämre för att studiorna var för stora', 'Elvis slutade sjunga helt och lät bara instrumenten höras'],
  'ak7-tema-016|6': ['För att lärare ska ge högre betyg', 'För att man då slipper göra läxor', 'För att andra människor ska tycka synd om en'],
  'ak8-tema-011|5': ['Matlagning och trädgårdsskötsel', 'Sport och musik i skolan', 'Väderrapporter och trafikstockningar i städer'],
  'ak10-arsenal-002|6': ['Att Arsenal helt saknar strategi', 'Att unga spelare nästan alltid misslyckas', 'Att bollinnehav inte är viktigt'],
  'ak5-tema-015|3': ['Plastpåsar fastnar hårt i deras skal', 'Plastpåsar blockerar strömmarna', 'Sköldpaddor bygger bon av dem'],
  'ak7-historia-03|1': ['Att bygga en modell av en stad', 'Att skriva en längre fantasyberättelse', 'Att göra ett experiment i NO'],
  'ak9-tema-008|2': ['Att alla länder har exakt samma lagar', 'Att alla butiker är lokalt ägda', 'Att internet stängs av helt'],
  'ak6-tema-005|4': ['För att göra vattnet ännu saltare än det redan är i havet', 'För att locka fler turister till ön om somrarna', 'För att membranen ska hålla längre i kyla'],
  'gym-ai-skola-002|6': ['Lärande är att följa alla regler oavsett syfte', 'Lärande är att snabbt producera en helt färdig produkt', 'Lärande är att undvika misstag till varje pris'],
  'ak3-tema-003|1': ['På en buss mot skolan', 'I ett tyst klassrum', 'På en fotbollsplan'],
  'ak6-teknik-04|5': ['Att man helst ska gömma sina egna misstag', 'Att Noor nästan alltid har fel', 'Att man aldrig borde programmera'],
  'ak7-tema-019|4': ['För att det blir mycket lättare att spara pengar', 'För att alla människor blir rikare', 'För att priserna aldrig ändras alls'],
  'ak8-tema-012|1': ['Om en bok hon nyligen har läst', 'Om en resa till Marocko i somras', 'Om vanliga svenska matrecept'],
  'akgy-demo-001|6': ['De spelar ingen roll alls', 'De ersätter lagarna helt', 'De är endast symboliska'],
  'ak9-tema-020|3': ['För att kopior nästan alltid är tillverkade av rent guld', 'För att äkta varor aldrig säljs på nätet', 'För att kopior inte påverkar någon alls'],
  'ak7-tema-005|4': ['Att artister inte får rösta i val', 'Att musik är farligt för unga', 'Att fans bestämmer politiken'],
  'ak6-tema-024|6': ['Att segregationen aldrig påverkade musiken i USA över huvud taget', 'Att Elvis bara sjöng countrylåtar under hela sin karriär', 'Att radiostationerna på 1950-talet spelade all musik blandat helt utan problem'],
  'ak2-etik-06|6': ['Att man faktiskt kan bli sjuk av att vara snäll', 'Att mössor hoppar runt av sig själva', 'Att alla måste låna ut sina vantar'],
  'ak6-musik-05|6': ['Att öronmaskar betyder att man håller på att bli sjuk', 'Att musik alltid är farlig för hjärnan', 'Att hjärnan i grunden är svag'],
  'ak5-teknik-03|4': ['För att wifi-signalen inte ska bli för varm', 'För att det ska bli mycket svårare för andra att förstå', 'För att servern ska hinna vila mellan gångerna'],
  'ak1-tema-011|1': ['I ett högt träd', 'Uppe på taket', 'Inne i en bur'],
  'ak2-tema-001|1': ['I ett högt träd', 'Nere på marken', 'Uppe på taket'],
  'ak3-natur-002|5': ['Ett slags grön färg', 'En särskild sorts blad', 'Vatten nere i marken'],
  'ak3-tema-025|4': ['En sorts sport', 'En läxa i skolan', 'En slags medicin'],
  'ak6-miljo-09|5': ['För att man då aldrig behöver sortera något mera', 'För att havet då slutar ha strömmar', 'För att de gör plasten helt osynlig'],
  'ak6-samhalle-06|3': ['Privata banklån', 'Läxa till hemmet', 'Reklam i tv'],
  'ak6-tema-022|4': ['En musiker som enbart kunde spela piano', 'En kompositör som skrev låtar utan sång', 'En skådespelare som aldrig tidigare hade sjungit'],
  'ak10-obama-003|4': ['Utbildningen', 'Själva valet', 'Skolsystemet'],
  'ak10-rosa-001|6': ['Att bussarna var mycket viktiga för staden', 'Att lagar alltid följs av alla', 'Att protester aldrig fungerar'],
  'akgy-tema-003|5': ['Som ett tydligt bevis för modern astronomi', 'Som ett politiskt system', 'Som en ekonomisk teori'],
};
