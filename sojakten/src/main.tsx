    ...
    root.innerHTML = `
      <div style="min-height:100vh;display:flex;align-items:center;justify-content:center;font-family:system-ui;padding:2rem">
        <div style="max-width:360px;text-align:center">
          ...
          <button onclick="for(let i=localStorage.length-1;i>=0;i--){const k=localStorage.key(i);if(k&&k.startsWith('so_'))localStorage.removeItem(k)};location.reload()"
            style="background:#6366f1;color:#fff;border:none;padding:.75rem 2rem;border-radius:1rem;font-weight:700;font-size:1rem;cursor:pointer">
