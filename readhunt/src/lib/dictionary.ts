...
export const WORD_DICTIONARY: Record<string, WordDefinition> = {
  ...
  // Environment & nature (grades 4–10)
  'environmental': { def: 'Relating to the natural world and its protection', ex: 'The school started an environmental project.' },
  'pollution': { def: 'Harmful substances that damage air, water, or soil', ex: 'Plastic pollution harms ocean animals.' },
  'ecosystems': { def: 'Communities of living things and their environments', ex: 'Forests and reefs are different ecosystems.' },
  'conservation': { def: 'The protection of nature and natural resources', ex: 'Conservation helps endangered species survive.' },
  'sustainable': { def: 'Able to continue without harming the environment', ex: 'They use sustainable farming methods.' },
  'renewable': { def: 'A source of energy that does not run out', ex: 'Wind and solar power are renewable.' },
  'habitats': { def: 'The natural homes of animals or plants', ex: 'Pollution destroys many animal habitats.' },
  'wildlife': { def: 'Wild animals living in their natural environment', ex: 'The park protects local wildlife.' },
  'breeding': { def: 'The producing of young by animals', ex: 'Fish return to the river during breeding season.' },
  'coral': { def: 'A hard, colourful structure formed by tiny sea animals', ex: 'The coral reef was full of fish.' },
  'algae': { def: 'Simple plant-like organisms that grow in water', ex: 'Algae give coral its bright colours.' },
  'bleaching': { def: 'The process of losing colour and turning white', ex: 'Warmer water causes coral bleaching.' },
  'reforestation': { def: 'Planting trees to replace a destroyed forest', ex: 'Reforestation can repair damaged land.' },
  'biologist': { def: 'A scientist who studies living things', ex: 'A marine biologist studies ocean life.' },
  'recovery': { def: 'The process of returning to a normal or healthy state', ex: 'The reef showed signs of recovery.' },

  // Society, politics & history
  'community': { def: 'A group of people living in the same area', ex: 'The whole community helped clean the beach.' },
  'communities': { def: 'Groups of people living in the same areas', ex: 'Coastal communities depend on fishing.' },
  'societies': { def: 'Large groups of people living together with shared rules', ex: 'Ancient societies built impressive cities.' },
  'residents': { def: 'People who live in a particular place', ex: 'The residents complained about the noise.' },
  'villagers': { def: 'People who live in a village', ex: 'The villagers worked together after the storm.' },
  'generations': { def: 'Groups of people born around the same time', ex: 'Music can connect different generations.' },
  'cooperation': { def: 'The act of working together towards a goal', ex: 'Solving the problem required cooperation.' },
  'compromise': { def: 'An agreement reached when each side gives up something', ex: 'They reached a compromise after long talks.' },
  'negotiations': { def: 'Discussions aimed at reaching an agreement', ex: 'The negotiations lasted several weeks.' },
  'indigenous': { def: 'Originating naturally in a particular place; native', ex: 'Indigenous people shared traditional knowledge.' },
  'infrastructure': { def: 'The basic systems a place needs, like roads and power', ex: 'The storm damaged the city infrastructure.' },
  'economic': { def: 'Relating to money, trade, and resources', ex: 'The new factory brought economic benefits.' },
  'transition': { def: 'A change from one state or system to another', ex: 'The transition to clean energy took years.' },
  'adaptation': { def: 'A change made to fit new conditions', ex: 'Communities created adaptation plans for floods.' },
  'decades': { def: 'Periods of ten years', ex: 'Scientists studied the current for decades.' },
  'preservation': { def: 'The act of keeping something safe from harm or loss', ex: 'Language preservation protects culture.' },
  'globalization': { def: 'The process of the world becoming more connected', ex: 'Globalization spread ideas across borders.' },
  'minority': { def: 'A small part of a larger group', ex: 'The law protects minority languages.' },
  'traditions': { def: 'Customs or beliefs passed down over time', ex: 'The family kept its old traditions.' },
  'traditional': { def: 'Following long-established customs or methods', ex: 'They cooked a traditional meal.' },
  'identity': { def: 'The qualities that make a person or group unique', ex: 'Language is part of cultural identity.' },
  'exhibition': { def: 'A public display of objects or art', ex: 'The students organised a history exhibition.' },
  'accessible': { def: 'Easy to reach, enter, or use by everyone', ex: 'They made the building accessible for wheelchairs.' },
  'wheelchair': { def: 'A chair on wheels for people who cannot walk easily', ex: 'A student in a wheelchair joined the team.' },
  'encyclopedias': { def: 'Books containing information on many subjects', ex: 'The key was hidden behind old encyclopedias.' },
  'harbor': { def: 'A sheltered place where ships stay safely', ex: 'The boats returned to the harbor at night.' },
  'fishermen': { def: 'People who catch fish for a living', ex: 'The fishermen worried about the empty nets.' },

  // Science & technology
  'technology': { def: 'Tools and machines created using scientific knowledge', ex: 'Technology changes the way we learn.' },
  'experiment': { def: 'A test done to discover or prove something', ex: 'She designed an experiment about plants.' },
  'participants': { def: 'People who take part in an activity', ex: 'The participants answered several questions.' },
  'volunteers': { def: 'People who offer to do something without being paid', ex: 'Volunteers cleaned up the park.' },
  'disruption': { def: 'A serious disturbance that stops normal activity', ex: 'The storm caused major disruption.' },
  'circulation': { def: 'The movement of something around a system', ex: 'Ocean circulation affects the weather.' },
  'oceanography': { def: 'The scientific study of the ocean', ex: 'He studied oceanography at university.' },
  'precision': { def: 'The quality of being exact and accurate', ex: 'The instrument measured with great precision.' },
  'uncertainty': { def: 'The state of not being sure about something', ex: 'There is still uncertainty about the results.' },
  'autonomous': { def: 'Able to operate independently, without a human', ex: 'An autonomous car drives by itself.' },
  'biometric': { def: 'Relating to measurements of the body, like heart rate', ex: 'The watch records biometric data.' },
  'algorithms': { def: 'Sets of step-by-step rules computers follow', ex: 'Search engines use algorithms to rank results.' },
  'optimization': { def: 'The process of making something as good as possible', ex: 'The training focused on performance optimization.' },
  'neural': { def: 'Relating to the nerves or the brain', ex: 'The treatment targets certain neural pathways.' },
  'procedure': { def: 'An official or established way of doing something', ex: 'The medical procedure was safe.' },
  'verification': { def: 'The process of checking that something is true', ex: 'Verification of the sources took time.' },
  'documentation': { def: 'Written records that provide information or proof', ex: 'The historian searched the documentation.' },
  'mechanical': { def: 'Working like a machine; not natural or expressive', ex: 'He thought modern songs sounded mechanical.' },
  'efficient': { def: 'Working well without wasting time or energy', ex: 'The new system is more efficient.' },
  'stable': { def: 'Steady and not likely to change suddenly', ex: 'Electricity prices became more stable.' },

  // Mind, health & behaviour
  'psychological': { def: 'Relating to the mind and mental processes', ex: 'Athletes face huge psychological pressure.' },
  'anxiety': { def: 'A feeling of worry or fear', ex: 'Exams can cause a lot of anxiety.' },
  'trauma': { def: 'A deeply distressing experience', ex: 'The accident left him with trauma.' },
  'traumatic': { def: 'Deeply shocking or distressing', ex: 'It was a traumatic event for the family.' },
  'resilience': { def: 'The ability to recover quickly from difficulties', ex: 'Sport can build resilience.' },
  'ambition': { def: 'A strong desire to achieve something', ex: 'Her ambition was to become a doctor.' },
  'competitive': { def: 'Involving rivalry; eager to win', ex: 'He plays in a competitive league.' },
  'counseling': { def: 'Professional advice and support for personal problems', ex: 'The school offers counseling for students.' },
  'compassion': { def: 'A feeling of sympathy and care for others', ex: 'She treated the patients with compassion.' },
  'adversity': { def: 'A difficult or unpleasant situation', ex: 'He stayed calm in the face of adversity.' },
  'autonomy': { def: 'The right or ability to make your own decisions', ex: 'Patients have autonomy over their treatment.' },
  'conformity': { def: 'Behaviour that matches the group, even when wrong', ex: 'The experiment studied conformity.' },

  // Ideas, media & debate
  'commercial': { def: 'Relating to buying and selling for profit', ex: 'A commercial version of the product appeared.' },
  'corporations': { def: 'Large companies or businesses', ex: 'Several corporations supported the project.' },
  'regulatory': { def: 'Relating to official rules that control something', ex: 'A regulatory agency approved the technology.' },
  'accountability': { def: 'The responsibility to explain or answer for actions', ex: 'The trial raised questions of accountability.' },
  'philosopher': { def: 'A person who studies ideas about life and knowledge', ex: 'The philosopher questioned the decision.' },
  'ideological': { def: 'Based on a set of beliefs or political ideas', ex: 'The debate became an ideological conflict.' },
  'journalists': { def: 'People who write news for newspapers, TV, or websites', ex: 'Journalists investigated the story.' },
  'manipulated': { def: 'Changed or controlled in a dishonest way', ex: 'Some videos had been manipulated.' },
  'archives': { def: 'Collections of historical records or documents', ex: 'The digital archives held old recordings.' },
  'intensified': { def: 'Became stronger or more extreme', ex: 'The debate intensified after the report.' },
  'amplified': { def: 'Made larger, louder, or more intense', ex: 'Social media amplified the rumour.' },
  'dismissed': { def: 'Rejected as unimportant', ex: 'They dismissed her concerns too quickly.' },
  'medicinal': { def: 'Used as medicine or to treat illness', ex: 'The plant has medicinal uses.' },
  'credits': { def: 'Points earned for completing a course', ex: 'He needed extra credits in science.' },

  // Sport & music
  'tournament': { def: 'A competition with many matches or games', ex: 'She trained hard for the tournament.' },
  'spectators': { def: 'People who watch an event', ex: 'Spectators filled the sports hall.' },
  'referee': { def: 'An official who makes sure rules are followed in a game', ex: 'The referee stopped the match.' },
  'rally': { def: 'A long exchange of shots in a game like tennis', ex: 'The final rally lasted a minute.' },
  'improvisation': { def: 'Making something up while performing, without planning', ex: 'Jazz is full of improvisation.' },
  'acoustic': { def: 'Producing sound naturally, without electronic help', ex: 'He preferred acoustic instruments.' },
  'composition': { def: 'A piece of music or writing that someone creates', ex: 'She shared her digital composition.' },

  // Useful intermediate words (grades 4–6)
  'although': { def: 'In spite of the fact that; even though', ex: 'Although it rained, the trip was fun.' },
  'however': { def: 'Used to add a fact that contrasts with the last one', ex: 'It was cold; however, we still went out.' },
  'instead': { def: 'In place of something else', ex: 'She drank tea instead of coffee.' },
  'several': { def: 'More than two but not very many', ex: 'Several students joined the club.' },
  'knowledge': { def: 'Information and understanding gained through learning', ex: 'Reading builds knowledge.' },
  'materials': { def: 'The substances things are made from', ex: 'Paper is made from natural materials.' },
  'factories': { def: 'Buildings where goods are made using machines', ex: 'The factories produced thousands of cars.' },
  'regions': { def: 'Areas or parts of a country or the world', ex: 'Some regions are warmer than others.' },
  'access': { def: 'The right or ability to use or reach something', ex: 'Students need access to good books.' },
  'produce': { def: 'To make or create something', ex: 'Wind turbines produce electricity.' },
  'especially': { def: 'More than usual; particularly', ex: 'She likes science, especially biology.' },
  'researchers': { def: 'People who study a subject carefully to discover facts', ex: 'Researchers tested the new idea.' },
};
