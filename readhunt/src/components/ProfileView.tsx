    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl border-b-8 border-indigo-100 dark:border-indigo-900 p-8">
        ...
        {user.completedTexts.length > 0 && (
          <div className="mb-8">
            <h3 className="text-lg font-bold text-slate-700 dark:text-slate-200 mb-3">Statistics</h3>
        ...
        {/* Badges */}
        <div>
          <h3 className="text-lg font-bold text-slate-700 dark:text-slate-200 mb-3">Achievements</h3>
