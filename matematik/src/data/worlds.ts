...
export const WORLDS: World[] = [
  {
    ...
    topicIds: ['rakna-till-10', 'addition-bas', 'subtraktion-bas', 'former-och-figurer', 'klockan', 'rakna-till-100', 'uppstallningar-lagstadiet'],
    islandEmojis: ['🌿', '🦕', '🥚', '🌋', '🦖', '🪨'],
  ...
  },
  {
    ...
    accentHex: '#8b5cf6',
    cardBg: 'bg-purple-50',
    topicIds: ['multiplikation-intro', 'division-intro', 'brak', 'decimaler', 'procent', 'geometri-omfang', 'uppstallningar-mellanstadiet'],
    islandEmojis: ['🧙', '🏰', '🐉', '⚔️', '🪄', '💎'],
  ...
  },
  {
    ...
    accentHex: '#3b82f6',
    cardBg: 'bg-blue-50',
    topicIds: ['algebra-intro', 'ekvationer', 'statistik', 'geometri-area', 'funktioner', 'sannolikhet', 'uppstallningar-hogstadiet'],
    islandEmojis: ['🛸', '🌍', '🤖', '⚗️', '💡', '🌌'],
