...
export const GYM_EXTENDED_TOPICS: Topic[] = [
  ...
  // ─── 2. POTENSER & POTENSLAGAR ────────────────────────────
  {
    ...
    exercises: [
      { id: 'pot-1', type: 'fill-in', question: '2³ · 2² = ?', answer: '32', points: 15, explanation: '2³·2² = 2⁵ = 32.' },
      { id: 'pot-2', type: 'multiple-choice', question: '(3²)³ = 3^? Vilken exponent?', options: ['5', '6', '8', '9'], correctIndex: 1, points: 15, explanation: '(aᵐ)ⁿ = aᵐ·ⁿ, så 2·3 = 6.' },
      { id: 'pot-3', type: 'fill-in', question: '5⁰ = ?', answer: '1', points: 10, explanation: 'Allt (utom 0) upphöjt till 0 är 1.' },
      { id: 'pot-4', type: 'fill-in', question: '2⁻³ = ? (skriv som bråk)', answer: '1/8', acceptableAnswers: ['1/8', '0.125', '0,125'], points: 20, explanation: 'a⁻ⁿ = 1/aⁿ, så 2⁻³ = 1/8.' },
      { id: 'pot-5', type: 'true-false', question: 'aᵐ · aⁿ = aᵐ⁺ⁿ', isTrue: true, points: 10, explanation: 'Rätt! Vid multiplikation av potenser med samma bas adderas exponenterna.' },
      { id: 'pot-6', type: 'multiple-choice', question: 'x⁵ / x² = ?', options: ['x³', 'x⁷', 'x²·⁵', 'x'], correctIndex: 0, points: 15, explanation: 'aᵐ/aⁿ = aᵐ⁻ⁿ, så x⁵⁻² = x³.' },
      { id: 'pot-7', type: 'fill-in', question: '9^(1/2) = ?', answer: '3', points: 15, explanation: 'a^(1/2) = √a, så 9^(1/2) = √9 = 3.' },
      { id: 'pot-8', type: 'multiple-choice', question: '(2x²)³ = ?', options: ['2x⁶', '8x⁶', '8x⁵', '6x⁶'], correctIndex: 1, points: 20, explanation: '(2x²)³ = 2³·x²·³ = 8x⁶.' },
      { id: 'pot-9', type: 'true-false', question: 'a⁻ⁿ = 1/aⁿ', isTrue: true, points: 10, explanation: 'Rätt! En negativ exponent ger inversen.' },
      { id: 'pot-10', type: 'order', question: 'Ordna potenserna från minst till störst.', items: ['2⁻¹', '2⁰', '2²', '2³'], orderHint: 'från minst till störst', points: 20, explanation: 'Värdena är 0,5, 1, 4 och 8.' },
      { id: 'pot-11', type: 'match', question: 'Para ihop varje potens med sitt värde.', pairs: [
        { left: '2³', right: '8' },
        { left: '3²', right: '9' },
        { left: '4⁰', right: '1' },
        { left: '5²', right: '25' },
      ], points: 20, explanation: '2³=8, 3²=9, 4⁰=1, 5²=25.' },
      { id: 'pot-12', type: 'fill-in', question: '10⁴ = ?', answer: '10000', points: 15, explanation: '10⁴ = 10·10·10·10 = 10000.' },
    ],
  },
