  ...
  return (
    <div className="min-h-screen">
      ...
      <div className={`bg-gradient-to-r ${world.bg} text-white pb-6 pt-16 px-4 relative overflow-hidden`}>
        <div className="absolute right-0 top-0 opacity-15 text-8xl pointer-events-none select-none p-4">
          {world.emoji}
        </div>
        <div className="max-w-lg mx-auto">
          <button
            onClick={() => setView('dashboard')}
            className="text-white/70 hover:text-white text-sm mb-3 flex items-center gap-1"
          >
            ← Välj värld
          </button>
          <div className="flex items-center gap-3 mb-3">
            <div
              className="text-5xl leading-none bg-white/25 rounded-2xl p-1.5 inline-flex items-center justify-center shadow-md flex-shrink-0"
              style={{ boxShadow: '0 4px 16px rgba(0,0,0,0.35)' }}
            >
              {world.emoji}
            </div>
            <div>
              <h1 className="text-2xl font-black" style={{ textShadow: '0 2px 8px rgba(0,0,0,0.4)' }}>
                {world.name}
              </h1>
          ...
          >
            ...
            <div className="h-2.5 rounded-full overflow-hidden" style={{ background: 'rgba(255,255,255,0.20)' }}>
              <div
