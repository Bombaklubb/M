...
const GAMES: {
...
}[] = [
  {
    ...
    emoji: '🃏',
    title: 'Memory',
    subtitle: 'Para ihop svenska med engelska!',
    description: 'Lätt (8 kort) • Medel (14 kort) • Svår (20 kort). Hitta alla par!',
  ...
  },
  {
    ...
    emoji: '❤️',
    title: 'Hänga gubben',
    subtitle: '6 liv – gissa rätt bokstav!',
    description: 'Gissa matematikord bokstav för bokstav. Skolvänlig variant med hjärtan!',
