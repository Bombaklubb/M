...
/**
 * Samma bakgrund som appens rubrik — familjens färger blandade över en mörk bas.
 *
 ...
 * be om lösenordet). Testet i `test/middleware.test.mjs` jämför strängen med `FAMILY_GRADIENT`, så
...
const AVATARS = ['martin', 'astrid', 'signe', 'bodil'];
const RINGS: Record<string, string> = { martin: '#86efac', astrid: '#d8b4fe', signe: '#f9a8d4', bodil: '#fdba74' };
